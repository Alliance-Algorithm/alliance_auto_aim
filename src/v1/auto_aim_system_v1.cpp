...
public:
    SystemV1Impl() {
        ...
        tracker_                               = predictor;
        identifier::Identifier* identifier     = new identifier::Identifier(
            ParamsForSystemV1::szu_model_path(), ParamsForSystemV1::device());
        identifier_ = identifier;
        fire_control::TracingFireControl* fire_control =
            new fire_control::TracingFireControl(ParamsForSystemV1::control_delay_in_second(),
                ParamsForSystemV1::velocity_begin(), ParamsForSystemV1::gravity());
        ...
        pnpsolver::ArmorIPPEPnPSolver* armor_pnp = new pnpsolver::ArmorIPPEPnPSolver();
        ...
        core::EventBus::Subscript<enumeration::CarIDFlag>(
            ...
            [this](const auto& data) {
                core::EventBus::Publish<interfaces::IPredictor>(
                    ParamsForSystemV1::get_lastest_predictor_event, tracker_->GetPredictor(data));
            });
        core::EventBus::Subscript<interfaces::IPredictor>(
            ParamsForSystemV1::get_lastest_predictor_event, //
            [this, &fire_control](const auto& data) {
